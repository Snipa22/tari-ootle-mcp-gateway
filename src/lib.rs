...
//! integration (see AGENTS.md): the audit log, the transaction rate limiter, and the
//! walletd client wrapper. The axum server bootstrap and CLI arg parsing (the
//! standalone-only bits) live in `main.rs`, not here.
//!
